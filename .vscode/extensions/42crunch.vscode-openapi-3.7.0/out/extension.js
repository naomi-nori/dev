...
function activate(context) {
    ...
    // OpenAPI v2 outlines
    vscode.window.registerTreeDataProvider('openapiTwoSpecOutline', new outline_1.GeneralTwoOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoPathOutline', new outline_1.PathOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoDefinitionOutline', new outline_1.DefinitionOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoSecurityOutline', new outline_1.SecurityOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoSecurityDefinitionOutline', new outline_1.SecurityDefinitionOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoParametersOutline', new outline_1.ParametersOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiTwoResponsesOutline', new outline_1.ResponsesOutlineProvider(context, didChangeTreeValid.event));
    // OpenAPI v3 outlines
    vscode.window.registerTreeDataProvider('openapiThreePathOutline', new outline_1.PathOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiThreeSpecOutline', new outline_1.GeneralThreeOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiThreeComponentsOutline', new outline_1.ComponentsOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiThreeSecurityOutline', new outline_1.SecurityOutlineProvider(context, didChangeTreeValid.event));
    vscode.window.registerTreeDataProvider('openapiThreeServersOutline', new outline_1.ServersOutlineProvider(context, didChangeTreeValid.event));
