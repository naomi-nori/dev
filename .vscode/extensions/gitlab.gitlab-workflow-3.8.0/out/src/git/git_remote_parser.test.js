...
describe('git_remote_parser', () => {
    it.each([
        ...
        expect(git_remote_parser_1.parseGitRemote('https://gitlab.com', remote)).toEqual({
            host,
            namespace,
            project,
        });
    ...
    it('should support self managed GitLab on a custom path', () => {
        expect(git_remote_parser_1.parseGitRemote('https://example.com/gitlab', 'https://example.com/gitlab/fatihacet/gitlab-vscode-extension')).toEqual({
            host: 'example.com',
            namespace: 'fatihacet',
